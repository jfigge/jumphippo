...
//
// Every store gate (self-updater short-circuit, the omitted "Check for
// Updates…" menu item) funnels through these helpers, so pinning their truth
// table is the highest-value coverage for the feature. The helpers read
// Electron's process.mas / process.windowsStore globals, which we toggle
// directly here (Node sets neither, so the default is a "direct" build).
