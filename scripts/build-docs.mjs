...
// temp prefix and points us at it via MARKED_DIR (see deploy-site.yml).
...
// Keep in lockstep with PAGES in src/web/scripts/components/docs-viewer.js
...
// from the raw characters (e.g. "Host keys &amp; trust" → "Host keys & trust")
...
:root{--bg:#1c1c1c;--mantle:#161616;--crust:#101010;--surface-0:#2a2a2a;--surface-1:#383838;--overlay-0:#686868;--text:#e8e8e8;--subtext:#b0b0b0;--accent:#4785F0;--green:#80c080}
